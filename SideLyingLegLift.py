...
class LegLiftDetector:
    def __init__(self, master, video_path, min_detection_confidence=0.5, min_tracking_confidence=0.5):
        ...
        self.title_label = tk.Label(self.master, text="Side Lying Leg Lift Exercise Detection", foreground="black", font=("Arial", 20, "bold"))
        self.title_label.place(relx=0.5, rely=0, anchor=tk.N)
